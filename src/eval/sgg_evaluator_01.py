...
class Evaluator(object):
    ...
    def evaluate(self):
        ...
        self.stats.update(eval_pred_prec_rec_simple(
            det_graph_val,      
            gt_graph_val,      
            args={}
        ))

        res = eval_ent_prec_rec_simple(
            det_graph_val,      
            gt_graph_val,      
            args={
        ...
        res.update(eval_triple_prec_rec_simple(
            det_graph_val,      
            gt_graph_val,      
            args={
                'localization_method': 'iou',
        ...
        for key, val in res.items():
            self.stats[f'{key}_at100_noloc'] = val
