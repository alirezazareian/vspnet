## from vsp_model_001.py: simple mp instead of 3-stage
            ...
            for step in range(num_mp_iter):
                with tf.variable_scope(f'mp_iter_{step}'): 
                    ...
                    with tf.variable_scope(f'mp_comp_messages_role'):
                        ...
                        message_received_ent2pred = tf.reduce_sum(message_pooled_ent2pred, axis=2)
                        ...
                        message_received_pred2ent = tf.reduce_sum(message_pooled_pred2ent, axis=2)
