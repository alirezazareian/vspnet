## from vsp_model_002.py: fully connected graph 
...
class Model(AbstractModel):
    def __init__(self, 
        ...
        with tf.variable_scope('graph_generator'):
            ...
            att_weights_mp = tf.ones((batch_size, num_roles, max_num_pred, num_proposals), dtype=tf.float32) / (float(num_roles) * tf.cast(num_proposals, tf.float32))
